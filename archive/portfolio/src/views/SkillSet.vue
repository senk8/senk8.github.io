...
export default {
  ...
  data: () => ({
    ...
    skills:[{language:"Rust",icon_name:"mdi-language-rust",description:"個人開発用の言語。最も力を入れている。"},
            {language:"Python",icon_name:"mdi-language-python",description:"研究、バックエンドに使用"},
            ...
            {language:"3級色彩コーディネーター",icon_name:"mdi-material-design",description:"資格、過去にデザイナーに興味があったため"},
    ]
  }),
  components:{
    SectionFrame,
